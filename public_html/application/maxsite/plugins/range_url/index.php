	...
	mso_admin_plugin_options('plugin_range_url', 'plugins', 
		array(
			...
			'page_404_redirect' => array(
							'type' => 'checkbox', 
							'name' => t('В случае неверной страницы осуществлять автоматический редирект на 404-страницу', 'plugins'), 
							'description' => t('Если опция не отмечена, то будет только выставляться тип данных «page_404» для дальнейшей обработки.', 'plugins'), 
							'default' => '0'
						),
						
			'page_404_header' => array(
							'type' => 'checkbox', 
							'name' => t('Отправлять 404-заголовок (header) браузеру', 'plugins'), 
							'description' => '', 
							'default' => '1'
						),
...
(page)(*)(next)(*)', 'plugins'), 
			...
			'siteurl_enable' => array(
							'type' => 'checkbox', 
							'name' => t('Включить определение главного зеркала сайта', 'plugins'), 
							'description' => '', 
							'default' => '0',
							'group_start' => 1,
							'group_end' => 0,
			...
			'siteurl' => array(
							'type' => 'text', 
							'name' => t('Укажите адрес главного зеркала сайта', 'plugins'), 
							'description' => t('Если входящий адрес не будет принадлежать указанному, то будет осуществлён редирект на главное зеркало сайта. Адрес следует указывать в полном формате, например: <b>http://site.com/</b> или <b>http://www.site.com/</b>', 'plugins'), 
