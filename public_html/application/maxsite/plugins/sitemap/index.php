...
function sitemap($arg = '')
{
	...
	if ($pages)
	{
		...
		$out .= '<div class="sitemap-link"><a href="' . getinfo('siteurl') . 'sitemap/cat">' . t('Группировка по рубрикам', 'plugins') . '</a>' . NR . '</div>';
...
function sitemap_cat($arg = '')
{
	...
	$out .= '<div class="sitemap-link"><a href="' . getinfo('siteurl') . 'sitemap">' . t('Группировка по датам', 'plugins') . '</a>' . NR . '</div>';
