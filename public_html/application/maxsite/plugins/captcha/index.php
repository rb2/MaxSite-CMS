...
function captcha_go($args = array()) 
{
	...
	echo '
			<div class="captcha"><label for="comments_captha">' . t('Введите нижние символы', 'plugins') . '</label>
			...
			. '&amp;code='
			. time()
			. '" alt="" title="' . t('Защита от спама: введите только нижние символы', 'plugins') . '"> <span>' . t('(обязательно)', 'plugins') . '</span><br><br></div>
		';
}
